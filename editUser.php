...
if (isset($_GET['jenis']) && isset($_GET['id_user'])) {
	...
	// hapus record
	$query 	= "SELECT nama_lengkap, username, password FROM $jenis WHERE id_user=$id";
...
if (isset($_POST['update'])) {
	...
	$query 	= "UPDATE $jenis SET nama_lengkap='$nama', username='$username', password='$md5' WHERE id_user=$id";
	$result	= mysqli_query($koneksi, $query);
