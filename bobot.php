...
?>
	<div id="layoutSidenav_content">
		<div class="container-fluid px-4">
			...
			<h1 class="mt-4">Perbandingan Alternatif</h1>

			<div class="ui breadcrumb">
				<a class="section"><i class="fa-solid fa-magnifying-glass-chart"></i>Analisa Data</a>
				<div class="divider"> / </div>
				<div class="active section"><i class="fa-solid fa-file-lines"></i>Perbandingan Alternatif Terhadap Kriteria <?php echo getKriteriaNama($jenis - 1) ?></div>
			</div>
			...
			<h2 class="ui header">Penentuan Bobot Alternatif Terhadap Kriteria <?php echo getKriteriaNama($jenis - 1) ?></h2>
